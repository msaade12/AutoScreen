; Inno Setup Script for AutoScreen
; Install to Program Files with desktop icon

#define MyAppName "AutoScreen"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "AutoScreen"
...
AllowNoIcons=yes
OutputDir=installer
OutputBaseFilename=AutoScreen_Setup
Compression=lzma
